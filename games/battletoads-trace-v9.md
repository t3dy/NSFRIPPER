---
layout: default
title: Battletoads trace v9
---

# Battletoads trace v9

**1 tracks** extracted via NSF emulation with per-frame APU register capture.

**Driver family:** Family 2: Active Envelope — CC11/note: 3.38, CC12/note: 0.04
...
|---|-------|-------|-----|----------|
| 1 | battletoads trace 01 Ragnoraks Canyon | 885 | 3024 | 305s |

**Total: 885 note events, 3,024 CC automation events**

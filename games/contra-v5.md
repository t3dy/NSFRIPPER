...
**3 tracks** extracted via NSF emulation with per-frame APU register capture.

**Driver family:** Family 1: Sparse Envelope (sub-group 1B) — CC11/note: 2.48, CC12/note: 0.01
...
|---|-------|-------|-----|----------|
| 1 | contra jungle v5 | 1303 | 3242 | 298s |
| 2 | contra jungle v5c | 1303 | 3242 | 298s |
| 3 | contra jungle v5d | 1303 | 3242 | 298s |

**Total: 3,909 note events, 9,726 CC automation events**
